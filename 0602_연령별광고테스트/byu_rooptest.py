...
KEY = '677b4f68016b494fa458bc1b4b2cacb3'
CF.Key.set(KEY)
...
while True:
        #time.sleep(17)
	cap = cv2.VideoCapture(0) # using USB1

	capture_result = 0 # 카메라가 정상적으로 동작해서 촬영을 했는지 확인하는 변수
	...
	if capture_result != -1: # 카메라가 정상적으로 동작한 경우
